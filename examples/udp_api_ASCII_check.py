...
"""
! Don't forget to check /.env (see .env.example) for IP and Port settings
"""
...
def recursive_collect_methods(cls: type, prefix: str = "", visited: set[type] | None = None) -> dict[str, list[str]]:
    """
...
def get_all_methods(module: str, root_class_name: str) -> dict[str, list[str]]:
    ...
    :usage: methods = get_all_methods('exelltech_remote_control', 'api')
